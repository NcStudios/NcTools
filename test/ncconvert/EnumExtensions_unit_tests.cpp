...
TEST(EnumExtensionsTest, ToAssetType_fromString_succeeds)
{
    ...
    EXPECT_EQ(nc::convert::ToAssetType("skeletal-animation-clip"), nc::asset::AssetType::SkeletalAnimationClip);
...
TEST(EnumExtensionsTest, ToString_fromAssetType_succeeds)
{
    ...
    EXPECT_EQ(nc::convert::ToString(nc::asset::AssetType::SkeletalAnimationClip), "skeletal-animation-clip");
